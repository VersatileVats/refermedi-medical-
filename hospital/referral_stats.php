                    ...
                    onCommand: function(commandData) {
                        if (commandData.command === "referredByUs") {
                            ...
                            if (elements.length == 0) {
                                alanBtnInstance.callProjectApi("noRecord", {
                            ...
                            for (let j = 0; j < elements.length; j++) {
                                ...
                                alanBtnInstance.callProjectApi("referByUs", {
                            ...
                            for (let k = 0; k < elements.length; k++) {
                                ...
                                alanBtnInstance.callProjectApi("referToUs", {
                                    value: elements[k].innerHTML
                                }, function(error, result) {
                                    console.log(error);
                                });
                            }
                            ...
                            alanBtnInstance.callProjectApi("checkHospitalPage", {
                                value: window.location.href
                            }, function(error, result) {
                                console.log(error);
                            });
                        } else if (commandData.command === "addName") {
                            alanBtnInstance.callProjectApi("checkPatientPage", {
                                value: window.location.href
                            }, function(error, result) {
                                console.log(error);
                            });
